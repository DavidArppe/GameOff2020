...
namespace UnityMovementAI
{
    ...
    public class SteeringBasics : MonoBehaviour
    {
        ...
        {
#if UNITY_EDITOR
            Physics.Raycast(targetPosition + Vector3.up * 1000.0f, Vector3.down, out RaycastHit rayHit, 2000.0f);

            Debug.DrawLine(transform.position, rayHit.point, Color.cyan, 0f, false);
            #endif
