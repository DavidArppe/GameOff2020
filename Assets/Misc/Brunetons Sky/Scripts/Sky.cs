...
namespace BrunetonsAtmosphere
{
    ...
    public class Sky : MonoBehaviour
    {
        ...
        public float radiusOfEarth = -40000.0f;
        ...
        private void OnEnable()
        {
            ...
            string path = Application.streamingAssetsPath + m_filePath + "/transmittance.raw";
            ...
            path = Application.streamingAssetsPath + m_filePath + "/irradiance.raw";
            ...
            path = Application.streamingAssetsPath + m_filePath + "/inscatter.raw";
        ...
        public void UpdateMat(Material mat)
        {
            ...
            m_sunlight.intensity = Mathf.Clamp01(Vector3.Dot(m_sun.transform.forward, Vector3.down) * 100.0f);
            ...
            mat.SetTexture("_StarMap", m_starTexture);
            mat.SetFloat("SUN_INTENSITY", m_sunIntensity);
            mat.SetVector("EARTH_POS", new Vector3(0.0f, -radiusOfEarth, 0.0f));
